...
**Status:** Result log · **Companion to:** [RFC-001](https://github.com/fastverk/spec/blob/main/rfc-001-unified-spec-graph.md), [RFC-001b](https://github.com/fastverk/spec/blob/main/rfc-001b-crystallization-math.md)
