...
**Symmetry detection (S).** [`motifs.ttl`](https://github.com/fastverk/rules_spec/blob/main/corpus/motifs.ttl) makes the motif
structure explicit; [`motif-orbits.rq`](https://github.com/fastverk/rules_spec/blob/main/corpus/motif-orbits.rq) groups the
