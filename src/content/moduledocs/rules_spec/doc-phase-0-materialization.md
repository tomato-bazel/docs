...
- **Seed graph** — [`corpus/ratio-corpus.ttl`](https://github.com/fastverk/rules_spec/blob/main/corpus/ratio-corpus.ttl): the
  ...
  ([`rdf/ontology/aion-rfc.ttl`](https://github.com/fastverk/rules_spec/blob/main/rdf/ontology/aion-rfc.ttl)). No new vocabulary
...
- **First frontier standard internalized** —
  [`corpus/nav-sec-2a4.ttl`](https://github.com/fastverk/rules_spec/blob/main/corpus/nav-sec-2a4.ttl): SEC mutual-fund NAV
  ...
  [`docs/frontier/nav-sec-2a4.claims.json`](https://github.com/fastverk/rules_spec/blob/main/frontier/nav-sec-2a4.claims.json).
