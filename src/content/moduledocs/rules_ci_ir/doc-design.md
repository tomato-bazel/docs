...
The Lean code lives under [`ir/`](https://github.com/tomato-bazel/rules_ci_ir/blob/main/ir/); the Rust workspace
lives under [`translator/`](https://github.com/tomato-bazel/rules_ci_ir/blob/main/translator/). The two are kept in
