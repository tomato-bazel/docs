...
## 1. Convention macros — [`//tomato:defs.bzl`](https://github.com/tomato-bazel/rules_fastverk/blob/main/tomato/defs.bzl)
...
## 2. The dependency BOM — [`//bom/versions.json`](https://github.com/tomato-bazel/rules_fastverk/blob/main/bom/versions.json)
...
## 3. The shared `.bazelrc` — [`//bazelrc:common.bazelrc`](https://github.com/tomato-bazel/rules_fastverk/blob/main/bazelrc/common.bazelrc)
