...
1. Reads `lean-toolchain`, downloads the matching Lean tarball
   (sha256-pinned for [known versions](https://github.com/tomato-bazel/rules_lean/blob/main/lean/private/known_lean_versions.bzl)).
...
| Layer                | Pinned by                                                |
| -------------------- | -------------------------------------------------------- |
| Lean toolchain       | `sha256` in [`lean/private/known_lean_versions.bzl`](https://github.com/tomato-bazel/rules_lean/blob/main/lean/private/known_lean_versions.bzl) |
...
- **Lean**: 4.29+ tested. Other versions: add the platform sha256 to
  [`lean/private/known_lean_versions.bzl`](https://github.com/tomato-bazel/rules_lean/blob/main/lean/private/known_lean_versions.bzl)
