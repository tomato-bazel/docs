...
The Lean code lives under [`ir/`](https://github.com/tomato-bazel/rules_ci/blob/main/ir/); the Rust workspace
lives under [`translator/`](https://github.com/tomato-bazel/rules_ci/blob/main/translator/). The two are kept in
...
User-facing Bazel rules in [`rules/defs.bzl`](https://github.com/tomato-bazel/rules_ci/blob/main/rules/defs.bzl):
