...
tools, the escalation seam) is documented in [`docs/VERSIONING.md`](https://github.com/tomato-bazel/rules_ci/blob/main/docs/VERSIONING.md). The Rust
CI-IR translator (`//translator`, dev-scoped) and its proof strategy are in
[`docs/DESIGN.md`](https://github.com/tomato-bazel/rules_ci/blob/main/docs/DESIGN.md).
